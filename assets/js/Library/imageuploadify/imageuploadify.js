...
(function($, window, document, undefined) {
    ...
    const compareMimeType = (mimeTypes, fileType, formatFile) => {
        ...
        // console.log(mimeTypes, fileType, formatFile)
    ...
    $.fn.imageuploadify = function(opts) {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          <button type="button" class="btn btn-default">Click để chọn</button>
        </div>
      </div>
      `);
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'>
                  <button type='button' class='btn fas fa-trash'></button>
                ...
                if (file.type && file.type.search(/image/) != -1) {
                    ...
                    fReader.onloadend = function(e) {
                        ...
                        let image = $("<img>");
                        // Paste the image source to display the image preview.
                        image.attr("src", `/assets/images/default/extension_file/${fileExtension}.png`);
            ...
            $(self).closest("form").on("submit", function(event) {
               ...
               //  xhr.send(formData);
                callAPI('POST',$(this).attr("action"),formData, (data)=>{
                    success("Thành công")
                },undefined, true,true)
